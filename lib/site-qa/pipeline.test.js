...
(async function flow() {
  ...
  const visualResult = {
    ...
    pages: [
      { path: '/', cand: T + '/', viewports: [ { label: '1920 · desktop-xl', pixelMismatchPct: 1.2, matchScore: 98, struct: {} }, { label: '480 · mobile', pixelMismatchPct: 14.5, matchScore: 71, struct: { moved: 2, restyled: 1 } } ] },
