...
var PRIO='all', IGN=Object.create(null);
...
function issueList(){var out=[];
  ...
  return out;}
function issueRow(x){var c=x.c,ig=!!IGN[x.key],n=(c.items||[]).length;
  return '<div class="iss'+(ig?' ignored':'')+'" data-prio="'+x.tier+'" data-key="'+x.key+'">'
