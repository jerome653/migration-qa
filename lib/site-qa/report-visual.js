...
function render(data, outDir) {
  ...
  <div class="wrap">
    <div class="vm-hero">
      ...
      <div style="text-align:right"><div class="vm-score">${data.overall}%</div><div class="vm-sub">${redesign ? 'structural match' : 'overall match'}</div></div>
    </div>
