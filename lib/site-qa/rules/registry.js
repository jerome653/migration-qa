...
const REGISTRY_VERSION = '1.5.0'; // bump on ANY rule metadata change; every scan records this. 1.1.0: +SEO-029/030. 1.2.0: +Suite 11 Best Practices (advisory, weight 0 — provably score-neutral; WP-007). 1.2.1: +FUNC-008 content-artifacts. 1.3.0: +Suite 12 Visual Match (advisory, weight 0 — VIS-001/002; folded from qa-visual-match into the pipeline). 1.3.1: +FUNC-009 common-misspelling. 1.4.0: +CON-003 blocking-overlay (consent/age-gate dismissal, additive). 1.5.0: +tier field on every rule (launch-readiness; additive, scoring untouched).
