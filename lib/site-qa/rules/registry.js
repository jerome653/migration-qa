...
const REGISTRY_VERSION = '1.9.0'; // 1.6.0: +Interaction B1. 1.7.0: +Security B2. 1.8.0: +SEO B3. 1.9.0: +Stability B4 (DOM-003/004 dup-id/complexity, FORM-002 field-semantics, LINK-010 mailto/tel. Broken-markup/fonts deferred). // bump on ANY rule metadata change; every scan records this. 1.1.0: +SEO-029/030. 1.2.0: +Suite 11 Best Practices (advisory, weight 0 — provably score-neutral; WP-007). 1.2.1: +FUNC-008 content-artifacts. 1.3.0: +Suite 12 Visual Match (advisory, weight 0 — VIS-001/002; folded from qa-visual-match into the pipeline). 1.3.1: +FUNC-009 common-misspelling. 1.4.0: +CON-003 blocking-overlay (consent/age-gate dismissal, additive). 1.5.0: +tier field on every rule (launch-readiness; additive, scoring untouched).
...
const RULES = [
  ...
  // ---------------- LINKS & REDIRECTS ----------------
  R('LINK-001', 'broken-internal-link', 'Broken internal link(s)', 'links', 'integrity', 'high', 12, 'network', { tier: 1 }),
  ...
  R('SEC-020', 'backup-exposed', 'Backup / archive file exposed', 'security', 'exposure', 'high', 14, 'network', { introduced: '2.0', inspector: 'security', cost: 'moderate', evidenceQuality: 'verified', fixability: 'manual', impact: { seo: null, a11y: null, security: 'high', devEffort: 'low' } }),
  ...
  R('SEC-024', 'password-over-http', 'Password field served over HTTP', 'security', 'transport', 'high', 14, 'static', { introduced: '2.0', inspector: 'security', cost: 'cheap', evidenceQuality: 'verified', fixability: 'manual', impact: { seo: null, a11y: null, security: 'high', devEffort: 'med' } }),
  R('SEC-025', 'login-form-get', 'Login form uses method=GET (credentials in URL)', 'security', 'transport', 'high', 10, 'static', { introduced: '2.0', inspector: 'security', cost: 'cheap', evidenceQuality: 'verified', fixability: 'manual', impact: { seo: null, a11y: null, security: 'high', devEffort: 'low' } }),
