...
module.exports = {
  ENGINE_VERSION: '2.2.0',   // canonical evidence naming (page--section--component[--issue]--viewport) + per-issue element shots
  REPORT_VERSION: '1.1.0',   // quality score + versions + rule ids in findings
