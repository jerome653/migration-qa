...
module.exports = { run, readAndShoot, clampWarmLoads, normalizeMode, normalizeAxes, MODES, VIEWPORTS, DEVICES, BREAKPOINTS, UA, contextOptionsFor, structDelta, pixelDiff, pairByPath, pathOf };
