  ...
  <div class="wrap">
    ...
    <section class="panel on" id="p-audit">
      ...
      <div class="card">
        ...
        <div class="grp" style="margin-top:2px"><div class="glab">Viewports <span class="help" tabindex="0">?<span class="tip"><b>Viewports</b>Which device widths the browser-render responsive sweep tests. Fewer = faster; all selected = the full matrix. AA colour-contrast still runs once even if desktop is deselected.<em>Leave all selected to keep the standard 10-width sweep.</em></span></span></div><div class="chips" id="a-vps">
  ...
  <script>
    ...
    (function(){
      ...
      load(function(saved){ st=saved||{};
        ...
        GROUPS.forEach(function(g){var c=$(g);if(!c||!st[g])return;c.querySelectorAll('input').forEach(function(i){i.checked=st[g].indexOf(i.value)>=0;});});
