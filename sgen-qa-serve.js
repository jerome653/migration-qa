...
function appPage() {
    ...
    <section class="panel" id="p-visual">
      ...
      <div class="toolgrid">
        <div class="col-left"><div class="card">
          ...
          <div class="grp"><div class="glab">Viewports <span class="help" tabindex="0">?<span class="tip"><b>Viewports</b>SGEN standard responsive breakpoints used for visual comparison.<em>1920 · 1199 · 991 · 767 · 575 · 480</em></span></span></div><div class="chips" id="v-vps">
            <label class="chip"><input type="checkbox" value="1920" checked>1920</label><label class="chip"><input type="checkbox" value="1199" checked>1199</label><label class="chip"><input type="checkbox" value="991" checked>991</label><label class="chip"><input type="checkbox" value="767" checked>767</label><label class="chip"><input type="checkbox" value="575" checked>575</label><label class="chip"><input type="checkbox" value="480" checked>480</label></div></div>
  ...
  <script>
    var VPMAP={1920:'1920 · desktop-xl',1199:'1199 · desktop',991:'991 · tablet-landscape',767:'767 · tablet',575:'575 · mobile-landscape',480:'480 · mobile'};
